...
question1="What is the Page Object Model in Selenium and why is it useful?"
actual_output1=session.ask(question1)
print("Actual output1 is:" ,actual_output1 )
print("*****************************************************")
question2="How do I create a browser context and a new page in Playwright?"
actual_output2=session.ask(question2)
print("Actual output2 is:" ,actual_output2 )
print("*****************************************************")

question3="In Python, how do I open and read a text file safely using a context manager?"
actual_output3=session.ask(question3)

print("Actual output3 is:" ,actual_output3 )
print("*****************************************************")

topicAdherence_test= ConversationalTestCase(
 turns=[
 Turn(
    role="user",
    content=question1
...
metric = TopicAdherenceMetric(threshold=0.5 , model=modelObj,
   relevant_topics=[
        "Java",
        "Java Classes",
        "Java Objects",
...
evaluate(test_cases=[topicAdherence_test],metrics=[metric])